...
exports.PaginationDto = exports.GetStatsQueryDto = void 0;
...
], GetStatsQueryDto.prototype, "startDate", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'End date for filtering' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsDateString)(),
    __metadata("design:type", String)
], GetStatsQueryDto.prototype, "endDate", void 0);
class PaginationDto {
    constructor() {
        this.limit = 10;
        this.offset = 0;
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Number of items to return', default: 10 }),
    (0, class_validator_1.IsOptional)(),
...
//# sourceMappingURL=get-stats-query.dto.js.map